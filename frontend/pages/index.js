...
export default function HomeScreen() {
  return (
    <div className="lightgrey">
      <Card className="thumbIndex darkgrey">
        <Card className="">
          <Row className="w">
            <Col id="caro">
          ...
          <Row>
            <Col>
              <Card className="mb-2 mt-2">
                <Card.Body>
                  <Card.Text id="bh">
                    Tailor Made Computer Designs <br></br>Products,
                    Specification, and Installation <br></br>Exact Quotation in
                    Writing and Gauranteed for 30 days <br></br>
                    <Link href="computer1">
                      <a>
